...
Pour l'utiliser, on a mles méthode
    ...
    listAll(+/-tri, +/-tri) : récupère tout les champs de tous les objet de la table
...
class _model {
    ...
    protected $fields = [];      // Liste des noms des champs, avec le type de champ
    ...
    function delete() {
        ...
        // Cela s'aplique à l'objet base de données : il est en variable static, c'est $bdd
        $bdd = static::bdd();
        $req = $bdd->prepare($sql);
