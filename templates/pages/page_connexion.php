    ...
    <main>
        <div class="container flex w300p mrlauto">
            <div>
                ...
                <form class="mt32 flex column" action="index.php?controleur=connecter" method="post">
                    <div class="flex">
            ...
            <div class="w100 flex j-end"><a class="mt80" href="index.php?controleur=afficher_regle"><button class="fs10 btnActif">📜 Règles du jeu</button></a></div>            
            <div class="flex j-end w300p mrlauto mt80">
                <p class="w100 txt-end yellow fs12">Pas encore de personnage ?</p>
                <div class="w100 flex j-end"><a href="index.php?controleur=afficher_form_creation"><button class="mt16 wfit fs12 btnActif">Créer un personnage</button></a></div>
            </div>
        </div>
    </main>
