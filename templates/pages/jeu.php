        ...
        <div class="perso">
            <div class="w100 flex j-between a-center">
                <div class="flex j-between a-center">
                    <a href="index.php?controleur=deconnecter"><button class="fs10 w20p btnActif">🚪</button></a>
                    <a href="index.php?controleur=afficher_regle"><button class="fs10 w20p btnActif">📜</button></a>
                </div>
