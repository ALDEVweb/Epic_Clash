    ...
    <main>
        <div class="container flex w300p mrlauto j-center">
            <div>
                ...
                <form class="mt32 flex column" action="index.php?controleur=creer" method="post">
            ...
            <div class="w100 flex j-end"><a href="index.php"><button class="wfit mt48 fs12 btnActif">Annuler</button></a></div>
        </div>
    </main>
